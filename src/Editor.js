	...
	render() {
		...
		return (
			<section id="editor-wrapper">
				<Toolbar name={"Editor"} isExpanded={isExpanded} onChange={this.handleExpandOrCollapse} />
				<textarea id="editor" onChange={this.handleTextChange} className={maximized} type="text" value={markdown} />
			</section>
		);
	}
}
