	...
	render() {
		...
		return (
			<section id="preview-wrapper">
				<Toolbar name={"Previewer"} isExpanded={isExpanded} onChange={this.handleExpandOrCollapse} />
				<div id="preview" dangerouslySetInnerHTML={createMarkup(parsedMarkdown)} className={maximized}>
				</div>
			</section>
		);
	}
